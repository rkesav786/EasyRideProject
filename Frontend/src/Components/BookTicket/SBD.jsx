  ...
  return (
    <>
      <div className="container p-4 mt-3" id={style.cardcontainer}>
        <div className="cardcontainer" id={style.insurencefont}>
          <h4 className="mt-2 mb-3">Passenger Information</h4>
          <div className="card">
            <div className="card-body p-2">
              <div className="row ">
                <div className="col-12">
                  <span>LION Travels</span>
                </div>
              </div>
              <div className="row p-3">
                <div className="buscard d-flex justify-content-between">
                  <div className="boarding col-6">
                    <p className="m-0"> Porur</p>
                    <p className="m-0">Chennai</p>
                    <p>20:00 Wed,Jul 17</p>
                  </div>
                  <span>
                    <IoMdArrowForward />
                  </span>
                  <div className="dropping col-6 text-end">
                    <p className="m-0">Pavoorchatram</p>
                    <p className="m-0 disabled">Pavoorchatram</p>
                    <p className="m-0">07:00 Wed,Jul 18</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="row border" id={style.insurencefont}>
                <div className="col-8 mt-3  ">
                  <div className="amount">
                    <h6>
                      Amount: <b className="text-danger"> RS 1099 </b>
                    </h6>
